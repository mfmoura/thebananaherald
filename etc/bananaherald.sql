...
CREATE TABLE `pais` (
  ...
  `nomeIngles` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `usuarios` (
  ...
  KEY `fk_usuario_pais_idx` (`pais`),
  KEY `fk_usuario_sexo_idx` (`sexo`),
  CONSTRAINT `fk_usuario_cidade` FOREIGN KEY (`cidade`) REFERENCES `cidade` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `assuntos` (
  `id` int(11) NOT NULL,
  `nome` varchar(45) NOT NULL,
  `admin_criador` int(11) NOT NULL,
  `ativo` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_admin_assunto_idx` (`admin_criador`),
  CONSTRAINT `fk_admin_assunto` FOREIGN KEY (`admin_criador`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `sessoes` (
  ...
  `ativo` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_admn_sessao_idx` (`admin_criador`),
  CONSTRAINT `fk_admn_sessao` FOREIGN KEY (`admin_criador`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `assunto_sessao` (
  ...
  UNIQUE KEY `uk_assunto_sessao` (`assunto`,`sessao`),
  KEY `fk_assunto_sessao_idx` (`assunto`),
  KEY `fk_sessao_assunto_idx` (`sessao`),
  CONSTRAINT `fk_assunto_sessao` FOREIGN KEY (`assunto`) REFERENCES `assuntos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sessao_assunto` FOREIGN KEY (`sessao`) REFERENCES `sessoes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `comentarios` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_comentario_usuario_idx` (`usuario`),
  KEY `fk_comentario_topico_idx` (`topico`),
  CONSTRAINT `fk_comentario_topico` FOREIGN KEY (`topico`) REFERENCES `topicos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_comentario_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `comentarios_pontuacao` (
  ...
  UNIQUE KEY `uk_usuario_comentario_pontuacao` (`comentario`,`usuario`),
  KEY `fk_usuario_comentario_pontuacai_idx` (`usuario`),
  CONSTRAINT `fk_comentario_comentario_pontuacao` FOREIGN KEY (`comentario`) REFERENCES `comentarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_comentario_pontuacai` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `log_acessos_usuario` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_log_acesso_usuario_idx` (`usuario`),
  CONSTRAINT `fk_log_acesso_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `login` (
  ...
  CONSTRAINT `fk_login_usuarios` FOREIGN KEY (`id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `login_admin` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `login_UNIQUE` (`login`),
  CONSTRAINT `fk_admin_usuario` FOREIGN KEY (`id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `login_moderador` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `login_UNIQUE` (`login`),
  CONSTRAINT `fk_moderador_usuario` FOREIGN KEY (`id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `moderador_sessao` (
  ...
  `sessao` int(11) NOT NULL,
  PRIMARY KEY (`moderador`,`sessao`),
  KEY `fk_moderador_sessao_sessao_idx` (`sessao`),
  CONSTRAINT `fk_moderador_sessao_moderador` FOREIGN KEY (`moderador`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_moderador_sessao_sessao` FOREIGN KEY (`sessao`) REFERENCES `sessoes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `topico_pontuacao` (
  ...
  UNIQUE KEY `uk_topico_pontuacao` (`topico`,`usuario`),
  KEY `fk_pontuacao_usuario_idx` (`usuario`),
...
INSERT INTO `pais` (`id`, `nome`, `nomeIngles`) VALUES 
...
#
# Data for the `cidade` table  (LIMIT 5000,500)
#
...
#
# Data for the `cidade` table  (LIMIT 5500,500)
#
...
INSERT INTO `sexo` (`id`, `sexoNome`) VALUES 
  (1,'Masculino'),
  (2,'Feminino'),
  (3,'Indeterminante');
COMMIT;
